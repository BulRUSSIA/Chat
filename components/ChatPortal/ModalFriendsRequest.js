...
export class ModalFriendsRequest extends React.Component {
    ...
    _listEmptyComponent = () => {
        return (
            <View>
                <Text style={{color:'red',textAlign: 'center',fontSize: 15}}>нет заявок</Text>
            </View>
        )
...
<View style={{backgroundColor:'rgba(255,255,255,0.99)',width:width/1.8,marginTop:height/5,borderRadius:9}}>
    ...
    <Text style={{fontWeight:'bold',textAlign: 'center',marginBottom:10}}>Заявки в друзья</Text>
                                    ...
                                    <FlatList
                                        ...
                                        renderItem={(({item}) =>
                                                <TouchableOpacity  onPress={()=>this.props.friends_action(item.nic,item.id)}>
